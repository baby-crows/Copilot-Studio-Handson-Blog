...
> · 스크린샷·이미지는 본 페이지에 포함하지 않았으므로 실제 화면은 [원문 랩](https://microsoft.github.io/mcs-labs/labs/mcs-workflows/?event=advanced-agent-in-a-day)을 함께 참고하세요.
